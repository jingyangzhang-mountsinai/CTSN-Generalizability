...
mmr_cov <- mmr_dat %>% select(-first_mace_day, -mace, -randomization_assignment, -Y, -delta)
...
### Predict survival curve for the entire dataset. 
pred <- predict(mmr_csf, estimate.time.survival = TRUE)
